      ...
      >
        ...
        <div className="mx-auto max-w-[856px] relative before:absolute before:w-full before:max-w-[856px] before:h-[4px] before:bg-[#C4C4C4]  before:bottom-[-3px] before:left-[0%] ">
          <div className="flex items-center justify-between     ">
            <button className=" font-Poppins font-semibold text-[#000] text-[22px] sm:text-[26px] md:text-[30px] w-[50%] flex justify-center leading-[140%] max-w-[443px]  mx-auto  relative before:w-0 before:h-[4px]  before:bg-[#B00000] before:max-w-[443px]  before:absolute before:left-0 before:bottom-[-10%] before:duration-300 before:transition-all before:ease-linear before:hover:w-full  ">
              Basic
            </button>

            <button className=" font-Poppins font-semibold text-[#000] text-[22px] sm:text-[26px] md:text-[30px] leading-[140%] w-[50%] flex justify-center  relative before:w-0 before:h-[4px]  before:bg-[#B00000] before:max-w-[443px]  before:absolute before:left-0 before:bottom-[-10%] before:duration-300 before:transition-all before:ease-linear before:hover:w-full ">
              Premium
            </button>
          </div>
        </div>
        <div className="flex flex-row flex-wrap -mx-3 pt-[20px] sm:pt-[40px] md:pt-[60px]  justify-center">
          {Basic.map((props, index) => (
            <div key={index} className="w-full sm:w-6/12 lg:w-4/12  pt-6 px-3 ">
              <div className="flex justify-center items-center">
                <div className="pt-4 sm:pt-[34px] pb-8 sm:pb-[48px] pe-[20px] sm:pe-[29px] ps-6 sm:ps-[35px] border-[1.5px] border-[#C4C4C4] shadow-[0px_0px_4px_0px_#00000040_inset] rounded-[15px] max-w-[305px] hover:shadow-[0px_0px_6px_0px_#B00000_inset] hover:border-transparent transition-all duration-300 ease-linear cursor-pointer ">
                  ...
                  <h3 className=" font-Poppins font-semibold text-[#000] text-[32px] sm:text-[36px] md:text-[42px] leading-[76.19%] pt-5 sm:pt-[28px]">
                    {first ? props.CommonHeadingTwo : props.CommonHeadingThree}
                  </h3>
