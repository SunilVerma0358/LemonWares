            ...
            {first === "Tab1" && (
              <div className="pt-5 sm:pt-6 lg:pt-[28px]">
                ...
                <div className="flex gap-6 items-center pt-[30px] sm:pt-[40px] lg:pt-[60px]">
                  ...
                  <button className=" font-Poppins font-normal text-[#000] text-[12px] sm:text-[14px] leading-[171%]  border border-[#000] rounded-[8px]  p-3  hover:shadow-[0px_0px_64px_0px_#b000004d] transition-all ease-linear duration-300 hover:text-[#fff] hover:border-[#18191F] relative  isolation-auto z-10 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[#18191F] before:-z-10 before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700 ">
                    Choose your plan
                  </button>
                </div>
              </div>
